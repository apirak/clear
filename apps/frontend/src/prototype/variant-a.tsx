...
import { tickets, chatMessages, questionMeta, type Ticket, type ChatMessage } from './mock-data'

/**
 * Variant A — Classic Inbox (Intercom-style)
 * 3 fixed columns: sidebar nav | ticket list | chat | metadata
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#F3F4F6] p-2 dark:bg-[#0F1117] font-['Sarabun',sans-serif]">
      <div className="flex h-full gap-2">
        ...
        {/* Column 3: Metadata (always visible on desktop) */}
